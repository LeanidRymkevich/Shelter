...
9. При ширине экрана меньше 768px на обеих страницах меню в хедере скрывается, появляется
  иконка бургер-меню: +4

10. Верстка обеих страниц валидная: для проверки валидности вёрстки используйте сервис https://validator.w3.org/ : +8

Итого требования задания к обоим страницам выполнены, оценка максимальная - 100 баллов.
`);